<?php
$selectedValue1 = isset($_POST['selectedValue']) ? $_POST['selectedValue'] : '';
$totalScore1 = isset($_POST['totalScore']) ? $_POST['totalScore'] : '';
?>
<!DOCTYPE html>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card-body">
                                                <form id="formevaluation2" method="post">
                                                    ...
                                                    <p>Selected Value: <?php echo htmlspecialchars($selectedValue1); ?></p>
                                                    <p>Total Score: <?php echo htmlspecialchars($totalScore1); ?></p>
                                                    <hr>
                                                    ...
                                                    <div class="demo-inline-spacing d-flex justify-content-between">
                                                        ...
                                                        <button type="button" id="nextButton" class="btn btn-primary active">ถัดไป</button>
                                                    </div>
                                                </form>
                                                <script>
