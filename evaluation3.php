                                        ...
                                        <div class="col-sm-12">
                                            <div class="card-body">
                                                ...
                                                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                                    ...
                                                    $scoreall = $score + $score2 + $totalScore3 + $section15score + $section16score + $section17score + $totalScoreFromDatabase;
                                                    ...
                                                    $insertQuery = "INSERT INTO form_3 (scoreall, height, weight, bmi, pressureup, pressuredown, waistline, fat, fatblood, bloodlevel, pregnant, ovary, sex, age, status, province, study, section1, section2, section3, section4, section5, section6, section7, section8, section9, section10, section11, section12, section13, section14, section15, section16, section17) 
                                                    VALUES (:scoreall, :height, :weight, :bmi, :pressureup, :pressuredown, :waistline, :fat, :fatblood, :bloodlevel, :pregnant, :ovary, :sex, :age, :status, :province, :study, :section1, :section2, :section3, :section4, :section5, :section6, :section7, :section8, :section9, :section10, :section11, :section12, :section13, :section14, :section15, :section16, :section17)";
